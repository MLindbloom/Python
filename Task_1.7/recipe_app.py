...
class Menu(Recipe):
  ...
  def search_by_ingredients(self):
    ...
    try:
      ingredient_indexes = input('Enter the numbers for the ingredients you would like to search: ').split(' ')
      search_ingredients = []
  ...
  def edit_recipe(self):
    ...
    try:
      attribute = int(input('Enter the number of the attribute you would like to update: '))
    except ValueError:
      print('\nInvalid Input\n')
      return
    except:
  ...
  def delete_recipe(self):
    ...
    decision = input(f"Confirm you want to delete {recipe_to_delete.name}! Type 'yes': ")
